...
def test_probe_requires_diffusiondrive_release_version() -> None:
    assert probe_container.VERSION_ID == "simscale-diffusiondrive-navhard-e2e"


def test_probe_has_no_cross_submission_pythonpath_dependency() -> None:
