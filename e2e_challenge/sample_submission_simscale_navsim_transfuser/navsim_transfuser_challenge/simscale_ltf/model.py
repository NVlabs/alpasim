...
class BoundingBox2DIndex:
    """Indices of fields in a predicted 2D bounding box."""
...
class StateSE2Index:
    """Indices of fields in a predicted SE(2) pose."""
...
class TransfuserModel(nn.Module):
    ...
    def __init__(self, config: TransfuserConfig, num_poses: int = 8):
        """
        Initializes TransFuser torch module.
        :param config: global config dataclass of TransFuser.
        :param num_poses: number of trajectory poses to predict.
        """
