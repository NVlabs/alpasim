...
This plugin lets Alpasim use an external chunked video model as the renderer.
The wizard config entry point is:
...
uv run --project src/wizard alpasim_wizard \
  ...
  wizard.external_services.video_model='["<host>:50051"]' \
