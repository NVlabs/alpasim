...
$$ J = \\sum\_{i=i_0}^{N} (w\_{lon} e\_{lon,i}^2 + w\_{lat} e\_{lat,i}^2 + w\_{head} e\_{head,i}^2 +
w\_{accel} a_i^2) + \\sum\_{i=1}^{N} (w\_{\\Delta steer} \\Delta \\delta_i^2 + w\_{\\Delta accel}
\\Delta a_i^2) $$
